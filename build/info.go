...
// linker flag:
//   $> go build -ldflags "-X github.com/dihedron/mason/build.GitHash=$(hash)"
...
//   $> nm ./cloudctl-xxx | grep GitHash
//   00000000015db9c0 b github.com/dihedron/mason/build.GitHash
...
var (
	...
	BuildTime string
	// BuildDate is the date on which the application was built.
	BuildDate string
	// GitTag is the current Git tag (e.g. "1.0.3").
	GitTag string
	// GitCommit is the commit of this version of the application.
	GitCommit string
	// GitHash is the long hash of the Git commit.
	GitHash string
